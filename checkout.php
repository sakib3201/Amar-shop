                ...
                <?php else : ?>
                    ...
                    <div class="cart">
                        <table class="table table-responsive table-hover table-bordered">
                            ...
                            // $i = 0;
                            // foreach ($_SESSION['cart_p_discount_price'] as $key => $value) {
                            //     $i++;
                            //     $arr_cart_p_discount_price[$i] = $value - ($value * $_SESSION['data']['discount']) / 100;
                            // }
                            ...
                            <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                <tr>
                                    ...
                                    ?>
                                        <td><?php echo "&#2547;" ?><?php echo $arr_cart_p_current_price[$i] - ($arr_cart_p_current_price[$i] * $_SESSION["data"]["discount"]) / 100; ?></td>
                        ...
                        <?php else : ?>
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <form class="cash_on_delivery" action="<?php echo BASE_URL; ?>payment_success.php?payment_id=<?php echo time(); ?>" method="post" id="cash_on_delivery_form" target="_blank">
