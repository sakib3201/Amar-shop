...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="admin/assets/uploads/<?php echo $favicon; ?>">

	<!-- Stylesheets -->
	<link rel="stylesheet" href="admin/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="admin/assets/css/font-awesome.min.css">
	<link rel="stylesheet" href="admin/assets/css/owl.carousel.min.css">
	<link rel="stylesheet" href="admin/assets/css/owl.theme.default.min.css">
	<link rel="stylesheet" href="admin/assets/css/jquery.bxslider.min.css">
	<link rel="stylesheet" href="admin/assets/css/magnific-popup.css">
	<link rel="stylesheet" href="admin/assets/css/rating.css">
	<link rel="stylesheet" href="admin/assets/css/spacing.css">
	<link rel="stylesheet" href="admin/assets/css/bootstrap-touch-slider.css">
	<link rel="stylesheet" href="admin/assets/css/animate.min.css">
	<link rel="stylesheet" href="admin/assets/css/tree-menu.css">
	...
	<?php if ($cur_page == 'blog-single.php') : ?>
		...
		<meta property="og:image" content="admin/assets/uploads/<?php echo $og_photo; ?>">
	<?php endif; ?>
		...
		<div class="container">
			<div class="row inner">
				<div class="col-md-4 logo">
					<a href="index.php"><img src="admin/assets/uploads/<?php echo $logo; ?>" alt="logo image"></a>
				</div>
