		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview <?php if (($cur_page == 'employee.php') || ($cur_page == 'employee-add.php') || ($cur_page == 'employee-edit.php')) {
											echo 'active';
										} ?>">
						<a href="add_employee.php">
							<i class="fa fa-user-plus"></i> <span>Employee Registration</span>
						</a>
					...
					<li class="treeview <?php if (($cur_page == 'employee.php') || ($cur_page == 'employee-add.php') || ($cur_page == 'employee-edit.php')) {
						...
						<a href="employee_login.php">
							<i class="fa fa-user-plus"></i> <span>Employee Login</span>
						</a>
