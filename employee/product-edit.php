...
<?php include_once('save_coupon.php'); ?>
...
if (isset($_POST['form1'])) {
	...
	// if (!empty($coupon_code) && !empty($discount_price)) {
	$p_id = "";
	if (isset($_REQUEST['id'])) {
		$p_id = $_REQUEST['id'];
	}
	// }
	save_coupon($coupon_code, $discount_price, $pdo, $p_id);
	$current_price = $_POST['p_current_price'];
	// $discount = $discount_price;
	$discount_per = (($discount_price) ? $discount_price : 0) / 100;
	// echo $discount;
	$discount_val = $discount_per * $current_price;
	// echo $discount_val;
	$total_discount = $current_price - $discount_val;
	...
	if (empty($_POST['p_buy_price'])) {
		$valid = 0;
		$error_message .= "Buy Price can not be empty<br>";
	}
...
foreach ($result as $row) {
	...
	$p_buy_price = $row['p_buy_price'];
	$p_current_price = $row['p_current_price'];
	$p_discount_price = $row['p_discount_price'];
	$p_qty = $row['p_qty'];
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Top Level Category Name <span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Mid Level Category Name <span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">End Level Category Name <span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Old Price<br><span style="font-size:10px;font-weight:normal;">(In TK.)</span></label>
							<div class="col-sm-6">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Buy Price <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In TK.)</span></label>
							<div class="col-sm-6">
								<input type="text" name="p_buy_price" class="form-control" value="<?php echo $p_buy_price; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Current Price <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In TK.)</span></label>
							<div class="col-sm-6">
								<input type="text" name="p_current_price" class="form-control" value="<?php echo $p_current_price; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Discount Price <span></span><br><span style="font-size:10px;font-weight:normal;">(In TK.)</span></label>
							<div class="col-sm-6">
								<!-- <div class="form-group"> -->
								<div class="col-sm-4">
									<label>Coupon Code</label>
									<input type="text" class="form-control" name="coupon" id="coupon" readonly="readonly" />
									<!-- <br /> -->
								...
								<div class="col-sm-4">
									...
									<br>
									<input type="number" class="form-control" name="discount_price" min="10" value="<?php echo $discount_price; ?>" placeholder="Insert discount" />
								</div>
								<div class="col-sm-4">
									<!-- <br><br> -->
									<label>Discount (In Amount)</label>
									<br>
									<input type="text" class="form-control" name="p_discount_price" min="10" value="<?php echo $p_discount_price; ?>" placeholder="No need to change" />
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Select Size</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Select Color</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Change Featured Photo </label>
							<div class="col-sm-4" style="padding-top:4px;">
								<input type="file" name="p_featured_photo">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Other Photos</label>
							<div class="col-sm-4" style="padding-top:4px;">
