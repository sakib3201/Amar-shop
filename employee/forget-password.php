...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE tbl_employee SET emp_token=?,emp_timestamp=? WHERE emp_email=?");
        $statement->execute(array($token, $now, strip_tags($_POST['emp_email'])));

        $message = '<p>' . LANG_VALUE_142 . '<br> <a href="' . BASE_URL . 'reset-password.php?email=' . $_POST['emp_email'] . '&token=' . $token . '">Click here</a>';
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="employee_login.php" style="color:#e4144d;"><?php echo LANG_VALUE_12; ?></a>
                            </div>
                        </div>
                    </form>
                </div>
