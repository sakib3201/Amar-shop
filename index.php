    ...
    <div class="carousel-inner" role="listbox">
        ...
        ?>
            <div class="item <?php if ($i == 0) {
                                    echo 'active';
                                } ?>" style="background-image:url(admin/assets/uploads/<?php echo $row['photo']; ?>);">
        ...
        <div class="container">
            <div class="row">
                ...
                ?>
                    <div class="col-md-4">
                        <div class="item">
                            <div class="photo"><img src="admin/assets/uploads/<?php echo $row['photo']; ?>" width="150px" alt="<?php echo $row['title']; ?>"></div>
