...
<script src="admin/assets/js/jquery-2.2.4.min.js"></script>
<script src="admin/assets/js/bootstrap.min.js"></script>
<script src="https://js.stripe.com/v2/"></script>
<script src="admin/assets/js/megamenu.js"></script>
<script src="admin/assets/js/owl.carousel.min.js"></script>
<script src="admin/assets/js/owl.animate.js"></script>
<script src="admin/assets/js/jquery.bxslider.min.js"></script>
<script src="admin/assets/js/jquery.magnific-popup.min.js"></script>
<script src="admin/assets/js/rating.js"></script>
<script src="admin/assets/js/jquery.touchSwipe.min.js"></script>
<script src="admin/assets/js/bootstrap-touch-slider.js"></script>
