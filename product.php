                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <ul class="prod-slider">
                                ...
                                <li style="background-image: url(admin/assets/uploads/<?php echo $p_featured_photo; ?>);">
                                    <a class="popup" href="admin/assets/uploads/<?php echo $p_featured_photo; ?>"></a>
                                </li>
                                <?php
                                ...
                                foreach ($result as $row) {
                                ?>
                                    <li style="background-image: url(admin/assets/uploads/product_photos/<?php echo $row['photo']; ?>);">
                                        <a class="popup" href="admin/assets/uploads/product_photos/<?php echo $row['photo']; ?>"></a>
                                    </li>
                                <?php
                                }
                                ?>
                            ...
                            <div id="prod-pager">
                                <a data-slide-index="0" href="">
                                    <div class="prod-pager-thumb" style="background-image: url(admin/assets/uploads/<?php echo $p_featured_photo; ?>"></div>
                                </a>
                                <?php
                                $i = 1;
                                $statement = $pdo->prepare("SELECT * FROM tbl_product_photo WHERE p_id=?");
                                ...
                                ?>
                                    <a data-slide-index="<?php echo $i; ?>" href="">
                                        <div class="prod-pager-thumb" style="background-image: url(admin/assets/uploads/product_photos/<?php echo $row['photo']; ?>"></div>
                                    </a>
                                <?php
                                    $i++;
                                }
            ...
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    ?>
                        <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(admin/assets/uploads/<?php echo $row['p_featured_photo']; ?>);"></div>
